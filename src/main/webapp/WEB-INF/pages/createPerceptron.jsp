...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/MLS">Главная страница</a></div>
...
<table class="table information_json">
    <tr><th>Входной слой</th><td></td><td><input type="number" class="form-control" id="in_layer" placeholder="Количество нейронов"></td></tr>
    <tr>
    ...
    <tr><th>Выходной слой</th><td><select атрибуты class="form-control" id="out_layerf" placeholder="Активационная функция"><option Функция1>Ф1</option><option функция2>Ф2</option></select></td><td><input type="number" class="form-control" id="out_layern" placeholder="Количество нейронов"></td></tr>
    <tr><th><input type="submit" class="form-control"></th></tr>
</table>
</body>
<script src="<c:url value="/resources/js/NewPerceptron.js" />"></script>
